...
def create_heatmap_KDTsCir_annot(data_folder, assets_folder, filtered_file_name):
    ...
    if filtered_df_stable.shape[0] > 50:
        ...
        cluster_map = sns.clustermap(filtered_df_stable, cmap="RdBu_r", col_colors=[drug_action_colors_list], linewidths=0.5, cbar_kws={'label': 'SHAP Value'}, figsize=(fig_width,fig_height))
    ...
    plt.suptitle('Heatmap of Disease Map and relevant Drug-targets', fontsize=30, y=1.05)
